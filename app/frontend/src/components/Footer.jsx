      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="text-4xl font-black text-slate-900 tracking-tighter hover:opacity-80 transition-opacity mb-6 block">
            ...
            <div className="text-xs font-bold text-slate-400 uppercase tracking-widest">
              Developed by
              <div className="text-slate-900 mt-1 text-sm normal-case tracking-normal">Team 3 DevSecOps</div>
            </div>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/login" className="text-slate-500 hover:text-brand text-sm transition-colors font-medium">Account</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-slate-500 hover:text-brand text-sm transition-colors font-medium">Security</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-500 hover:text-brand text-sm transition-colors font-medium">
                <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center border border-slate-100">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-500 hover:text-brand text-sm transition-colors font-medium">
                <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center border border-slate-100">
                  <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current">
